 ...
 */
{
    class Details {
        constructor() {
            ...
            <button class="details__behance"><a href="https://www.behance.net/eurzua">Ver en behance</a></button>
        ...
        init() {
            ...
            this.DOM.cart = this.DOM.details.querySelector('.details__behance');
